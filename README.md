...
The interesting layer is everything around the LLM - retries, idempotency, durable pauses, provider abstraction and a clear safety boundary between _the agent proposes_ and _the user confirms_.
